...
RSpec.describe EmailAddressesController, type: :controller do
  ...
  let(:valid_attributes) {
    { address: "abc@abc.com", person_id: 1 }
  }
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      let(:alice) { Person.create({ first_name: "Alice", last_name: "Butkus" }) }
      let(:valid_attributes) { { address: "alicebutkus@butkus.com", person_id: alice.id } }
      ...
      it "redirects to the email address's person page" do
        post :create, {:email_address => valid_attributes}, valid_session
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      let(:valid_attributes) { { address: "abc@abc.com", person_id: bob.id } }
      let(:new_attributes) { { address: "xyz@xyz.com", person_id: bob.id } }
      ...
      it "updates the requested email_address" do
        ...
        expect(email_address.address).to eq("xyz@xyz.com")
        expect(email_address.person.first_name).to eq("Bob")
      end
  ...
  describe "DELETE #destroy" do
    ...
    it "redirects to the email_address's person page'" do
      email_address = EmailAddress.create! valid_attributes
      delete :destroy, {:id => email_address.to_param}, valid_session
      expect(response).to redirect_to(bob)
    end
